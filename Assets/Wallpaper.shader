Shader "Custom/Wallpaper"
{
    Properties
    {
        ...
        _NormalStrength("NormalStren", range(0,10)) = 1
    }
    SubShader
    {
        ...
        //Process stenciling for background
        Stencil {
        ...
        half _Glossiness;
        half _Metallic, _NormalStrength;
        fixed4 _Color;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            o.Normal = _NormalStrength * tex2D(_NormalTex, IN.uv_MainTex);
            o.Alpha = c.a;
        }
        ENDCG
    }
